...
export class AdminService {
  private getAllManagersUrl: string =
    'http://localhost:9091/managers/getAllManagers';
  private deleteManagerByEmailUrl: string =
    'http://localhost:9091/managers/deleteManager';
  private updateManagerUrl: string =
    'http://localhost:9091/managers/updateManager';

  private getAllEngineersUrl: string =
    'http://localhost:9091/engineers/getAllEngineers';
  private deleteEngineerByEmailUrl: string =
    'http://localhost:9091/engineers/deleteEngineer';

  private getAllCustomersUrl: string =
    'http://localhost:9091/customers/getAllCustomers';
  private deleteCustomerByEmailUrl: string =
    'http://localhost:9091/customers/deleteCustomer';
  private updateCustomerUrl: string =
    'http://localhost:9091/customers/updateCustomer';

  private getAllComplaintsUrl: string =
    'http://localhost:9091/complaints/getAllComplaints';
  ...
  private deleteFeedbackByFeedbackIdUrl: string =
    'http://localhost:9091/feedbacks/deleteFeedbackById';
  private updateFeedbackUrl: string =
    'http://localhost:9091/feedbacks/updateFeedback';
